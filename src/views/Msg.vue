...
export default {
  ...
  data() {
    return {
      ...
      hinataMember: [
        { name: '潮 紗理菜', avatar: require('@/assets/img/avatar/hinata/潮 紗理菜.jpg') },
        { name: '影山 優佳', avatar: require('@/assets/img/avatar/hinata/影山 優佳.jpg') },
        { name: '加藤 史帆', avatar: require('@/assets/img/avatar/hinata/加藤 史帆.jpg') },
        { name: '齊藤 京子', avatar: require('@/assets/img/avatar/hinata/齊藤 京子.jpg') },
        { name: '佐々木 久美', avatar: require('@/assets/img/avatar/hinata/佐々木 久美.jpg') },
        { name: '佐々木 美玲', avatar: require('@/assets/img/avatar/hinata/佐々木 美玲.jpg') },
        { name: '高瀬 愛奈', avatar: require('@/assets/img/avatar/hinata/高瀬 愛奈.jpg') },
        { name: '高本 彩花', avatar: require('@/assets/img/avatar/hinata/高本 彩花.jpg') },
        { name: '東村 芽依', avatar: require('@/assets/img/avatar/hinata/東村 芽依.jpg') },
        { name: '金村 美玖', avatar: require('@/assets/img/avatar/hinata/金村 美玖.jpg') },
        { name: '河田 陽菜', avatar: require('@/assets/img/avatar/hinata/河田 陽菜.jpg') },
        { name: '小坂 菜緒', avatar: require('@/assets/img/avatar/hinata/小坂 菜緒.jpg') },
        { name: '富田 鈴花', avatar: require('@/assets/img/avatar/hinata/富田 鈴花.jpg') },
        { name: '丹生 明里', avatar: require('@/assets/img/avatar/hinata/丹生 明里.jpg') },
        { name: '濱岸 ひより', avatar: require('@/assets/img/avatar/hinata/濱岸 ひより.jpg') },
        { name: '松田 好花', avatar: require('@/assets/img/avatar/hinata/松田 好花.jpg') },
        { name: '宮田 愛萌', avatar: require('@/assets/img/avatar/hinata/宮田 愛萌.jpg') },
        { name: '渡邉 美穂', avatar: require('@/assets/img/avatar/hinata/渡邉 美穂.jpg') },
        { name: '上村 ひなの', avatar: require('@/assets/img/avatar/hinata/上村 ひなの.jpg') },
        { name: '髙橋 未来虹', avatar: require('@/assets/img/avatar/hinata/髙橋 未来虹.jpg') },
        { name: '森本 茉莉', avatar: require('@/assets/img/avatar/hinata/森本 茉莉.jpg') },
        { name: '山口 陽世', avatar: require('@/assets/img/avatar/hinata/山口 陽世.jpg') },
        { name: '石塚 瑶季', avatar: require('@/assets/img/avatar/hinata/石塚 瑶季.jpg') },
        { name: '岸 帆夏', avatar: require('@/assets/img/avatar/hinata/岸 帆夏.jpg') },
        { name: '小西 夏菜実', avatar: require('@/assets/img/avatar/hinata/小西 夏菜実.jpg') },
        { name: '清水 理央', avatar: require('@/assets/img/avatar/hinata/清水 理央.jpg') },
        { name: '正源司 陽子', avatar: require('@/assets/img/avatar/hinata/正源司 陽子.jpg') },
        { name: '竹内 希来里', avatar: require('@/assets/img/avatar/hinata/竹内 希来里.jpg') },
        { name: '平尾 帆夏', avatar: require('@/assets/img/avatar/hinata/平尾 帆夏.jpg') },
        { name: '平岡 海月', avatar: require('@/assets/img/avatar/hinata/平岡 海月.jpg') },
        { name: '藤嶌 果歩', avatar: require('@/assets/img/avatar/hinata/藤嶌 果歩.jpg') },
        { name: '宮地 すみれ', avatar: require('@/assets/img/avatar/hinata/宮地 すみれ.jpg') },
        { name: '山下 葉留花', avatar: require('@/assets/img/avatar/hinata/山下 葉留花.jpg') },
        { name: '渡辺 莉奈', avatar: require('@/assets/img/avatar/hinata/渡辺 莉奈.jpg') },
      ],
      sakuraMember: [],
      nogiMember: [],
      // 定义要被拖拽对象的数组
